/*
 * ==========================================================================================
 *  Cutey Documentation JavaScript
...
(function () {
	...
	const CuteyDocs = {
		config: {
			...
			pageToolsId: "cutey-page-tools",
			progressId: "cutey-reading-progress",
			tableFilterClass: "cutey-table-filter",
			headingLinkClass: "cutey-heading-link",
			codeLabelClass: "cutey-code-label",
			codeToggleClass: "cutey-code-toggle",
			initializedAttribute: "data-cutey-enhanced",
			navScrollKey: "cutey-docs-nav-scroll",
		...
		addApiTools: function () {
			...
			panel.innerHTML = [
				...
				"<input id=\"cutey-api-search\" class=\"cutey-api-search\" type=\"search\" placeholder=\"Filter classes, methods, properties, or text...\" autocomplete=\"off\">",
				"<div class=\"cutey-api-tool-buttons\">",
				"<button type=\"button\" class=\"cutey-api-tool-button\" data-cutey-api-expand>Expand all</button>",
				"<button type=\"button\" class=\"cutey-api-tool-button\" data-cutey-api-collapse>Collapse all</button>",
